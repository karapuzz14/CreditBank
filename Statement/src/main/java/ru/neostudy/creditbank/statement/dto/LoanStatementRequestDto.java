package ru.neostudy.creditbank.statement.dto;
...
public class LoanStatementRequestDto {
  ...
  @NotNull
  @Email
  @Schema(description = "Адрес электронной почты клиента", requiredMode = Schema.RequiredMode.REQUIRED, example = "testmail@yandex.ru")
